...
function Page() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 flex items-center justify-center p-4 mt-10 sm:mt-24 relative overflow-hidden font-montserrat">
