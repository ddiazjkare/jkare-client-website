...
export const POST = async (req) => {
  try {
    ...
    const date = new Date();
    const shipment = await getShipment(checkout_session.metadata.shipment_id);
    ...
    const orderParams = {
      ...
      shipping_address: {
        ...
        line1: shipment.address_to.street1,
        line2: shipment.address_to.street2,
        postal_code: shipment.address_to.zip,
